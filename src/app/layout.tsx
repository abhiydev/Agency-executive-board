    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "KamiyTech - Custom Software, Web & AI Automation Agency",
      },
    ],
  },
  twitter: {
    ...
    title: "KamiyTech | Custom Software, Web & AI Automation Agency",
    description:
      "Enterprise custom software, Next.js web applications, mobile apps, and AI business automation engineered for scale.",
    creator: "@KamiyTech",
